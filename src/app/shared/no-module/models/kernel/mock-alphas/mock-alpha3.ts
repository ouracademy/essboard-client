...
export const state36: StateMetadata = new StateMetadata(
  'Cumplido',
  36,
  null,
  []
)
export const state35: StateMetadata = new StateMetadata(
  'Tratado',
  35,
  state36,
  []
)
export const state34: StateMetadata = new StateMetadata(
  'Aceptable',
  34,
  state35,
  []
)
export const state33: StateMetadata = new StateMetadata(
  'Coherente',
  33,
  state34,
  []
)
export const state32: StateMetadata = new StateMetadata(
  'Acotado',
  32,
  state33,
  []
)
export const state31: StateMetadata = new StateMetadata(
  'Concebido',
  31,
  state32,
  []
