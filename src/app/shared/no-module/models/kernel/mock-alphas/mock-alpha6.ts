...
export const state65: StateMetadata = new StateMetadata(
  'Concluido',
  65,
  state66,
  []
)
export const state64: StateMetadata = new StateMetadata(
  'Bajo control',
  64,
  state65,
  []
)
export const state63: StateMetadata = new StateMetadata(
  'Comenzado',
  63,
  state64,
  []
)
export const state62: StateMetadata = new StateMetadata(
  'Preparado',
  62,
  state63,
  []
)
export const state61: StateMetadata = new StateMetadata(
  'Iniciado',
  61,
  state62,
  []
...
export const checkpointsForState63: CheckpointMetadata[] = [
  ...
  },
  {
    identifier: '6-3-4',
    name:
      'Los miembros del equipo estan aceptando y progresando en los items de trabajo',
    description:
      'La solucion que satisface los interesados trata la oportunidad.',
    type: 'abbrev',
    state: state63
