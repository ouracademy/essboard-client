...
export const state55: StateMetadata = new StateMetadata(
  'Suspendido',
  55,
  null,
  []
)
export const state54: StateMetadata = new StateMetadata(
  'Ejecutando',
  54,
  state55,
  []
)
export const state53: StateMetadata = new StateMetadata(
  'Colaborando',
  53,
  state54,
  []
)
export const state52: StateMetadata = new StateMetadata(
  'Formado',
  52,
  state53,
  []
)
export const state51: StateMetadata = new StateMetadata(
  'Sembrado',
  51,
  state52,
  []
...
export const checkpointsForState52: CheckpointMetadata[] = [
  ...
  },
  {
    identifier: '5-2-2',
    name:
      'Se comprendieron la organizacion del equipo y las responsabilidades individuales',
    description:
      'Los interesados confirman que el nuevo sistema cumple con las expectativas.',
    type: 'abbrev',
    state: state52
