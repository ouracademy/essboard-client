...
export const state46: StateMetadata = new StateMetadata(
  'Retirado',
  46,
  null,
  []
)
export const state45: StateMetadata = new StateMetadata(
  'Operacional',
  45,
  state46,
  []
)
export const state44: StateMetadata = new StateMetadata(
  'Listo',
  44,
  state45,
  []
)
export const state43: StateMetadata = new StateMetadata(
  'Usable',
  43,
  state44,
  []
)
export const state42: StateMetadata = new StateMetadata(
  'Demostrable',
  42,
  state43,
  []
)
export const state41: StateMetadata = new StateMetadata(
