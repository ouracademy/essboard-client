...
const activitySpace1 = new ActivitySpaceMetadata("1-1",customer, 'Explore posibilities', '');
...
const activitySpace2 = new ActivitySpaceMetadata("1-2",customer, 'Understand Stakeholder Needs', '');
...
const activitySpace3 = new ActivitySpaceMetadata("1-3",customer, 'Ensure Stakeholder Satisfaction', '');
...
const activitySpace4 = new ActivitySpaceMetadata("1-4",customer, 'Use the system', '');
...
const activitySpace5 = new ActivitySpaceMetadata("2-1",solution, 'Understand the requeriments', '');
