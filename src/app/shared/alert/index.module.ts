...
export class AlertModule {
   ...
   constructor(@Optional() @SkipSelf() parentModule: AlertModule) {
    if (parentModule) {
      throw new Error('AlertModule is already loaded. It should only be imported in your application\'s main module.');
    }
  }
  static forRoot(config = {}): ModuleWithProviders {
    return {
      ...
      providers: [
        AlertService,
        { provide: ALERT_CONFIG, useValue: { config, defaults: DefaultGlobalConfig } }
      ],
    };
  }
