...
import {
  AreaMetadata,
  AlphaMetadata,
  ActivitySpaceMetadata
} from '../../model/metadata/kernel'
...
export class PrimaryKernelMockService {
  ...
  registerSpaceActivity(
    ...
    for (let ïdentifier of statesCompletion) {
      activitySpace.addCompletionCriteria(
        this.stateMockService.getState(ïdentifier)
      )
    }
