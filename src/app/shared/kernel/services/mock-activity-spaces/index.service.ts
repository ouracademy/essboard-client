...
export class ActivitySpaceMockService {
    ...
    constructor(public areaService: PrimaryKernelMockService, public stateService: StateMockService) {
    ...
    registerObject(code, area, name, objectives: string[], statesEntry: any[], statesCompletion: any[]) {
        ...
        for (let ïdentifier of statesCompletion) {
            activitySpace.addCompletionCriteria(this.stateService.getState(ïdentifier));
        }
