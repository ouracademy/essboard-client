...
export class StateMockService {
  ...
  getStateForAlpha(alphaIdentifier) {
    return this.states.filter(
      st => this.getIden(st.identifier) === alphaIdentifier
    )
  }
  ...
  private alpha1() {
    let state16: StateMetadata = new StateMetadata(
      'Satisfecho por el uso',
      16,
      null,
      []
    )
    let state15: StateMetadata = new StateMetadata(
      'Staisfecho por el despliegue',
      15,
      state16,
      []
    )
    let state14: StateMetadata = new StateMetadata(
      'De acuerdo',
      14,
      state15,
      []
    )
    let state13: StateMetadata = new StateMetadata(
      'Involucrado',
      13,
      state14,
      []
    )
    let state12: StateMetadata = new StateMetadata(
      'Representado',
      12,
      state13,
      []
    )
    let state11: StateMetadata = new StateMetadata(
      'Reconocido',
      11,
      state12,
      []
    )
    this.addStatesToStates([
      state16,
      state15,
      state14,
      state13,
  ...
  private alpha2() {
    let state26: StateMetadata = new StateMetadata(
    ...
    let state23: StateMetadata = new StateMetadata(
      'Con valor establecido',
      23,
      state24,
      []
    )
    let state22: StateMetadata = new StateMetadata(
      'Con solucion requerida',
      22,
      state23,
      []
    )
    let state21: StateMetadata = new StateMetadata(
      'Identificada',
      21,
      state22,
      []
  ...
  private alpha4() {
    ...
    let state45: StateMetadata = new StateMetadata(
      'Operacional',
      45,
      state46,
      []
    ...
    let state42: StateMetadata = new StateMetadata(
      'Demostrable',
      42,
      state43,
      []
    )
    let state41: StateMetadata = new StateMetadata(
  ...
  private alpha5() {
    ...
    let state54: StateMetadata = new StateMetadata(
      'Ejecutando',
      54,
      state55,
      []
    )
    let state53: StateMetadata = new StateMetadata(
      'Colaborando',
      53,
      state54,
      []
  ...
  private alpha6() {
    ...
    let state64: StateMetadata = new StateMetadata(
      'Bajo control',
      64,
      state65,
      []
  ...
  private alpha7() {
    ...
    let state75: StateMetadata = new StateMetadata(
      'Trabajando bien',
      75,
      state76,
      []
    )
    let state74: StateMetadata = new StateMetadata(
      'En su lugar',
      74,
      state75,
      []
    ...
    let state72: StateMetadata = new StateMetadata(
      'Con bases establecidas',
      72,
      state73,
      []
    )
    let state71: StateMetadata = new StateMetadata(
