...
export const state76: StateMetadata = new StateMetadata(
  'Retirado',
  76,
  null,
  []
)
export const state75: StateMetadata = new StateMetadata(
  'Trabajando bien',
  75,
  state76,
  []
)
export const state74: StateMetadata = new StateMetadata(
  'En su lugar',
  74,
  state75,
  []
)
export const state73: StateMetadata = new StateMetadata(
  'En uso',
  73,
  state74,
  []
)
export const state72: StateMetadata = new StateMetadata(
  'Con bases establecidas',
  72,
  state73,
  []
)
export const state71: StateMetadata = new StateMetadata(
...
export const checkpointsForState72: CheckpointMetadata[] = [
  ...
  },
  {
    identifier: '7-2-2',
    name:
      'Se analizaron y comprendieron las brechas entre practicas y herramientas',
    description:
      'Los interesados confirman que el nuevo sistema cumple con las expectativas.',
    type: 'abbrev',
    state: state72
